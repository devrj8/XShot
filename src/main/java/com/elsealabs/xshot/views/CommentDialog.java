...
import com.examples.RoundButton;
...
public class CommentDialog extends JDialog {
    ...
    public CommentDialog(Frame parent, JPanel refreshPanel, LShapeLine lShapeLine) {
        ...
        final InputStream is = CommentDialog.class.getResourceAsStream("Lato-Regular.ttf");
...
*/
        ...
        this.setLocationRelativeTo(refreshPanel);
